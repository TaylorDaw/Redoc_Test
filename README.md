# Flek_Test OpenAPI Specification
[![Build Status](https://travis-ci.org/TaylorDaw/Redoc_Test.svg?branch=master)](https://travis-ci.org/TaylorDaw/Redoc_Test)
...
6. If you did everything correct, https://taylordaw.github.io/Redoc_Test/ will lead to your new docs
...
- Documentation(ReDoc): https://taylordaw.github.io/Redoc_Test/
- SwaggerUI: https://taylordaw.github.io/Redoc_Test/swagger-ui/
- Look full spec:
    + JSON https://taylordaw.github.io/Redoc_Test/swagger.json
    + YAML https://taylordaw.github.io/Redoc_Test/swagger.yaml
- Preview spec version for branch `[branch]`: https://taylordaw.github.io/Redoc_Test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://taylordaw.github.io/Redoc_Test/ with url from the message: `Server started <url>`
